...
$(BUILD_DIR)/memory.o: kernel/memory.c kernel/debug.h \
        lib/kernel/print.h lib/stdint.h kernel/interrupt.h kernel/memory.h lib/kernel/bitmap.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/thread.o: thread/thread.c thread/thread.h lib/string.h lib/stdint.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/sync.o: thread/sync.c thread/sync.h lib/string.h lib/stdint.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/string.o: lib/string.c kernel/debug.h \
...
$(BUILD_DIR)/bitmap.o: lib/kernel/bitmap.c kernel/debug.h \
        lib/kernel/print.h lib/stdint.h kernel/interrupt.h lib/kernel/bitmap.h
	$(CC) $(CFLAGS) $< -o $@
